        ...
        <>
            ...
            <section id="uebermich" className="bg-white">
                <div className="max-w-[75%] mx-auto flex flex-col sm:flex-row items-center">
                    ...
                    <div id="logo" className="w-1/4 sm:w-1/3 flex justify-center sm:justify-center mt-4 sm:mt-0">

                    {/*Need new Image later*/}
                        <img src="https://media.gettyimages.com/id/2147648930/de/foto/sporty-beautiful-black-woman-in-red-sportswear.webp?s=612x612&w=gi&k=20&c=eXHjSZyyIGimRK53eZWkKveeCQGimZX_KD0KMM4zBko=" alt="test" className=" w-48 h-48 rounded-full object-cover" />
                    </div>
                </div>
            </section>
